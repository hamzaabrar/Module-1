...
let firstOccurranceOfStrive = testString.indexOf('Strive') // indexOf is a popular string method

console.log(firstOccurranceOfStrive)



let subString = testString.slice(5, 10) // subString is another popular string method
...
newArray.push('Tommy') // this is allowed in JavaScript, even with const
...
bark() // without this, the function will not get executed
...
const calculate5times4 = function(){
    ...
    console.log('THIS SHOULD BE THE FIRST CONSOLE LOG', value) // first one
